...
from pyG5.pyG5View import pyG5HSIWidget
from pyG5.pyG5Main import pyG5BaseWindow


class pyG5HSIApp(QApplication):
    """pyG5HSIApp PySide6 application.
    ...
    def __init__(self):
        ...
        self.mainWindow = pyG5HSIWindow()

        self.networkManager.drefUpdate.connect(
            self.mainWindow.pyG5HSI.drefHandler
        )
    ...
    def painTimerCB(self):
        ...
        self.mainWindow.pyG5HSI.update()
...
class pyG5HSIWindow(pyG5BaseWindow):
    """pyG5HSIApp PySide6 application.
    ...
    def __init__(self, parent=None):
        ...
        self.setCentralWidget(self.pyG5HSI)
